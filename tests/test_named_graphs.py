...
class TestPlanarity(unittest.TestCase):
    ...
    def test_balaban_10(self):
        expected = False
        seq = [68, -25, -18, 29, 13, 35, -13, -29, 19, 25, 9, -29, 29, 17, 33,
        ...
        actual = is_planar(nx.LCF_graph(70, seq, 1))
        self.assertEqual(expected, actual)

    def test_balaban_11(self):
        expected = False
        seq = [44, 26, -47, -15, 35, -39, 11, -27, 38, -37, 43, 14, 28, 51,
               -29, -16, 41, -11, -26, 15, 22, -51, -35, 36, 52, -14, -33, -26,
               -46, 52, 26, 16, 43, 33, -15, 17, -53, 23, -42, -35, -28, 30,
               -22, 45, -44, 16, -38, -16, 50, -55, 20, 28, -17, -43, 47, 34,
               -26, -41, 11, -36, -23, -16, 41, 17, -51, 26, -33, 47, 17, -11,
               -20, -30, 21, 29, 36, -43, -52, 10, 39, -28, -17, -52, 51, 26,
               37, -17, 10, -10, -45, -34, 17, -26, 27, -21, 46, 53, -10, 29,
               -50, 35, 15, -47, -29, -41, 26, 33, 55, -17, 42, -26, -36, 16]
        actual = is_planar(nx.LCF_graph(112, seq, 1))
        self.assertEqual(expected, actual)
    ...
    def test_biggs_smith(self):
        expected = False
        seq = [16, 24, -38, 17, 34, 48, -19, 41, -35, 47, -20, 34, -36, 21, 14,
               48, -16, -36, -43, 28, -17, 21, 29, -43, 46, -24, 28, -38, -14,
               -50, -45, 21, 8, 27, -21, 20, -37, 39, -34, -44, -8, 38, -21,
               25, 15, -34, 18, -28, -41, 36, 8, -29, -21, -48, -28, -20, -47,
               14, -8, -15, -27, 38, 24, -48, -18, 25, 38, 31, -25, 24, -46,
               -14, 28, 11, 21, 35, -39, 43, 36, -38, 14, 50, 43, 36, -11, -36,
               -24, 45, 8, 19, -25, 38, 20, -24, -14, -21, -8, 44, -31, -38,
               -28, 37]
        actual = is_planar(nx.LCF_graph(102, seq, 1))
        self.assertEqual(expected, actual)

    def test_tutte_12_cage(self):
        expected = False
        seq = [17, 27, -13, -59, -35, 35, -11, 13, -53, 53, -27, 21, 57, 11,
               -21, -57, 59, -17]
        actual = is_planar(nx.LCF_graph(126, seq, 7))
        self.assertEqual(expected, actual)
    ...
    def test_harries(self):
        expected = False
        seq = [-29, -19, -13, 13, 21, -27, 27, 33, -13, 13, 19, -21, -33, 29]
        actual = is_planar(nx.LCF_graph(70, seq, 5))
        self.assertEqual(expected, actual)

    def test_harries_wong(self):
        expected = False
        seq = [9, 25, 31, -17, 17, 33, 9, -29, -15, -9, 9, 25, -25, 29, 17, -9,
               9, -27, 35, -9, 9, -17, 21, 27, -29, -9, -25, 13, 19, -9, -33,
               -17, 19, -31, 27, 11, -25, 29, -33, 13, -13, 21, -29, -21, 25,
               9, -11, -19, 29, 9, -27, -19, -13, -35, -9, 9, 17, 25, -9, 9,
    ...
    def test_Ljubljana(self):
        expected = False
        seq = [47, -23, -31, 39, 25, -21, -31, -41, 25, 15, 29, -41, -19, 15,
        ...
        actual = is_planar(nx.LCF_graph(26, seq, 2))
        self.assertEqual(expected, actual)
